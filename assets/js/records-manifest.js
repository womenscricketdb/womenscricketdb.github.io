...
const WCA_RECORD_SECTIONS = {
    batting: {
        ...
        types: [
            { file: "Most_Runs", grain: "career", label: "Most Runs", sortCol: "Runs", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Runs_Milestones", grain: "career", label: "Fastest to Run Milestones", sortCol: "Innings", lowerIsBetter: true,
              qualifier: null,
              note: "Showing every player to reach a runs milestone, fewest innings first. Milestones step every 1000 runs in List A and Overall, every 500 runs in T20." },
            ...
            { file: "Highest_Score", grain: "innings", label: "Highest Individual Score",
              ...
              note: "Showing the top 25 for the selected filters." },
            { file: "Most_NotOuts", grain: "career", label: "Most Unbeaten Innings", sortCol: "Not Outs", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Batting_StrikeRate", grain: "career", label: "Batting Strike-rate", sortCol: "Batting Strike-rate",
              qualifier: { unit: "balls faced", seasonal: { "List A": 100, "T20": 50 }, allTime: 250 },
              note: "Showing the top 25 for the selected filters." },
            { file: "50Plus_Scores", grain: "career", label: "50+ Scores", sortCol: "50+ Scores", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "100Plus_Scores", grain: "career", label: "100+ Scores", sortCol: "100+ Scores", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "200Plus_Scores", grain: "career", label: "200+ Scores", sortCol: "200+ Scores", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Most_Fours", grain: "career", label: "Most Fours", sortCol: "Fours", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Most_Sixes", grain: "career", label: "Most Sixes", sortCol: "Sixes", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Most_Ducks", grain: "career", label: "Most Ducks", sortCol: "Ducks", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Most_GoldenDucks", grain: "career", label: "Most Golden Ducks", sortCol: "Golden Ducks", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Best_BoundaryCareer", grain: "career", label: "Best Batting Boundary %", sortCol: "Boundary %",
    ...
    bowling: {
        ...
        icon: "bi-dpad",
        types: [
            { file: "Most_Wickets", grain: "career", label: "Most Wickets", sortCol: "Wickets", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Wickets_Milestones", grain: "career", label: "Fastest to Wicket Milestones", sortCol: "Innings", lowerIsBetter: true,
              qualifier: null,
              note: "Showing every player to reach a wickets milestone, fewest innings first. Milestones step every 50 wickets, all formats." },
            ...
            { file: "Best_Inns_Economy", grain: "innings", label: "Most Economic Spell",
              ...
              note: "Showing the top 25 for the selected filters." },
            { file: "Most_5Wickets", grain: "career", label: "Most 5+ Wickets", sortCol: "5-for's", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Most_4Wickets", grain: "career", label: "Most 4+ Wickets", sortCol: "4-for's", qualifier: null, note: "Showing the top 25 for the selected filters." },
            ...
            { file: "Best_Bowl_StrikeRate", grain: "career", label: "Best Bowling Strike-rate", sortCol: "Bowling Strike-rate", lowerIsBetter: true,
              qualifier: { unit: "wickets", seasonal: { "List A": 10, "T20": 5 }, allTime: 40 },
              note: "Showing the top 25 for the selected filters." },
            { file: "Most_NoBalls", grain: "career", label: "Most No-Balls Bowled", sortCol: "No Balls", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Most_Wides", grain: "career", label: "Most Wides Bowled", sortCol: "Wides", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Most_Maidens", grain: "career", label: "Most Maidens", sortCol: "Maidens", qualifier: null, note: "Showing the top 25 for the selected filters." },
        ],
    },
    fielding: {
        ...
        types: [
            { file: "Most_D_RunOut", grain: "career", label: "Most Direct Run-Outs", sortCol: "Direct Run Outs", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Most_A_RunOut", grain: "career", label: "Most Assisted Run-Outs", sortCol: "Assisted Run Outs", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "WK_Dismissals", grain: "career", label: "Wicketkeeping Dismissals", sortCol: "Wicketkeeping Dismissals", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "WK_Stumpings", grain: "career", label: "Wicketkeeping Stumpings", sortCol: "Stumpings", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "WK_Catches", grain: "career", label: "Wicketkeeping Catches", sortCol: "Wicketkeeping Catches", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Field_Catches", grain: "career", label: "Fielder Catches", sortCol: "Catches (Field)", qualifier: null, note: "Showing the top 25 for the selected filters." },
    ...
    misc: {
        ...
        icon: "bi-stars",
        types: [
            { file: "Most_Matches", grain: "career", label: "Most Matches", sortCol: "Matches", qualifier: null, note: "Showing the top 25 for the selected filters." },
    ...
    partnerships: {
        ...
        icon: "bi-people-fill",
        types: [
            { file: "Highest_Partnership", grain: "innings", label: "Highest Partnership", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Most_Partnership_Runs", grain: "career", label: "Most Partnership Runs", sortCol: "Runs", qualifier: null, note: "Showing the top 25 for the selected filters." },
            { file: "Partnership_By_Wicket", grain: "innings", label: "Highest Partnership by Wicket", qualifier: null, note: "Showing the best partnership for each wicket." },
        ],
    },
    team: {
        label: "Team Records",
        ...
        types: [
            ...
            { file: "Most_Extras_Team", grain: "career", label: "Most Extras Bowled", sortCol: "Total Extras", qualifier: null, note: "Showing the top 25 for the selected filters." },
        ],
    },
    doubles: {
        ...
        icon: "bi-trophy-fill",
        types: [
            { file: "D_50_3", grain: "innings", label: "50 runs & 3 wickets", qualifier: null, note: "Showing every qualifying performance." },
            { file: "D_50_4", grain: "innings", label: "50 runs & 4 wickets", qualifier: null, note: "Showing every qualifying performance." },
            { file: "D_50_5", grain: "innings", label: "50 runs & 5 wickets", qualifier: null, note: "Showing every qualifying performance." },
            { file: "D_100_3", grain: "innings", label: "100 runs & 3 wickets", qualifier: null, note: "Showing every qualifying performance." },
            { file: "D_100_4", grain: "innings", label: "100 runs & 4 wickets", qualifier: null, note: "Showing every qualifying performance." },
            { file: "D_100_5", grain: "innings", label: "100 runs & 5 wickets", qualifier: null, note: "Showing every qualifying performance." },
            { file: "D_150_3", grain: "innings", label: "150 runs & 3 wickets", qualifier: null, note: "Showing every qualifying performance." },
            { file: "D_150_4", grain: "innings", label: "150 runs & 4 wickets", qualifier: null, note: "Showing every qualifying performance." },
            { file: "D_150_5", grain: "innings", label: "150 runs & 5 wickets", qualifier: null, note: "Showing every qualifying performance." },
            { file: "D_200_3", grain: "innings", label: "200 runs & 3 wickets", qualifier: null, note: "Showing every qualifying performance." },
        ],
    },
};
